...
//constructor
 field_::field_(){
    ...
    NUMBER_OF_LETTER_OF_SPACE_BETWEEN_COLUMNS = setting.getCastedToIntSettingFromEntireSetting("NUMBER_OF_SPACE_BETWEEN_COLUMNS");
    ...
    for(size_t i=0;i<NUMBER_OF_ROW;i++){
        field[i] = new char[(NUMBER_OF_LETTERS_IN_COLUMN + NUMBER_OF_LETTER_OF_SPACE_BETWEEN_COLUMNS)*NUMBER_OF_COLUMN + 1];
    }
